...
function getWebGLContext(e) {
    ...
    t = a ? (i.getExtension("EXT_color_buffer_float"),
    i.getExtension("OES_texture_float_linear")) : (r = i.getExtension("OES_texture_half_float"),
    i.getExtension("OES_texture_half_float_linear")),
    i.clearColor(0, 0, 0, 1);
    var o, l, u, c = a ? i.HALF_FLOAT : r.HALF_FLOAT_OES;
    return u = a ? (o = getSupportedFormat(i, i.RGBA16F, i.RGBA, c),
    l = getSupportedFormat(i, i.RG16F, i.RG, c),
    getSupportedFormat(i, i.R16F, i.RED, c)) : (o = getSupportedFormat(i, i.RGBA, i.RGBA, c),
...
var Material = function() {
    ...
    return _createClass(t, [{
        ...
        value: function(e) {
            ...
            n != this.activeProgram && (this.uniforms = getUniforms(n),
...
function resizeDoubleFBO(e, r, t, n, i, a, o) {
    return e.width == r && e.height == t || (e.read = resizeFBO(e.read, r, t, n, i, a, o),
...
document.addEventListener("mousemove", function(e) {
    if (!switchPage || !switchPage.switched) {
        var r = pointers[0];
        if (r.down)
            updatePointerMoveData(r, scaleByPixelRatio(e.pageX), scaleByPixelRatio(e.pageY))
    }
}),
...
document.addEventListener("touchmove", function(e) {
    if (!switchPage || !switchPage.switched) {
        ...
        for (var r = e.targetTouches, t = 0; t < r.length; t++) {
            var n = pointers[t + 1];
            if (n.down)
                updatePointerMoveData(n, scaleByPixelRatio(r[t].pageX), scaleByPixelRatio(r[t].pageY))
        }
    }
}, !1),
