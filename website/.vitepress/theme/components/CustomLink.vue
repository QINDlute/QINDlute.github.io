        ...
        <section class="flex group flex-col rounded-md p-4 gap-3 transition duration-500 cursor-pointer ">
          ...
          <div class="flex item-center justify-between">
            <div class="flex items-center gap-1 w-full max-w-[75%]">
              ...
              <simple-icons:markdown v-if="hrefSource === 'markdown'" class="w-7 h-7 text-slate-600" />
              <simple-icons:zhihu v-if="hrefSource === 'zhihu'" class="w-7 h-7 text-blue-600 dark:text-blue-400" />
